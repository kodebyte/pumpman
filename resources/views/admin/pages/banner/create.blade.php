<x-admin.app-layout pageTitle="Add Banner">
    ...
    <div class="pb-12" x-data="{ 
        ...
        // Helper untuk Preview Teks Banner
        getSeoTitle() {
            if(this.lang === 'en') return document.getElementsByName('title[en]')[0]?.value || 'Banner Title';
            return document.getElementsByName('title[id]')[0]?.value || 'Judul Banner';
        },
        getSeoDesc() {
            if(this.lang === 'en') return document.getElementsByName('subtitle[en]')[0]?.value || 'Banner subtitle...';
                                        ...
                                        <div class="mt-2 relative group cursor-pointer border-2 border-dashed border-gray-300 rounded-lg p-2 hover:bg-gray-50 transition h-40 flex items-center justify-center overflow-hidden" onclick="document.getElementById('image_desktop').click()">
                                            <template x-if="!imgPreviewDesktop">
                                                <div class="text-center text-gray-400">
                                                    <svg class="mx-auto h-8 w-8 mb-1" stroke="currentColor" fill="none" viewBox="0 0 48 48"><path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg>
                                                    <span class="text-xs">Upload Desktop</span>
                                                </div>
                                            </template>
                                            <template x-if="imgPreviewDesktop">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2 relative group cursor-pointer border-2 border-dashed border-gray-300 rounded-lg p-2 hover:bg-gray-50 transition h-40 flex items-center justify-center overflow-hidden" onclick="document.getElementById('image_mobile').click()">
                                            <template x-if="!imgPreviewMobile">
                                                <div class="text-center text-gray-400">
                                                    <svg class="mx-auto h-8 w-8 mb-1" stroke="currentColor" fill="none" viewBox="0 0 48 48"><path d="M12 8h24a4 4 0 014 4v24a4 4 0 01-4 4H12a4 4 0 01-4-4V12a4 4 0 014-4z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                                    <span class="text-xs">Upload Mobile</span>
                                                </div>
                                            </template>
                                            <template x-if="imgPreviewMobile">
