                        ...
                        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-admin.text-input name="name" :value="old('name')" required autofocus class="w-full text-lg font-semibold" placeholder="e.g. Administrator" />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <x-admin.text-input type="email" name="email" :value="old('email')" required class="w-full" placeholder="admin@company.com" />
