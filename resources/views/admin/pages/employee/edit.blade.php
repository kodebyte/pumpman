<x-admin.app-layout pageTitle="Edit Employee">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <x-admin.text-input name="name" :value="old('name', $employee->name)" class="w-full" required />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <x-admin.text-input type="email" name="email" :value="old('email', $employee->email)" class="w-full" required />
                                    ...
                                    <div>
                                        ...
                                        <select name="role" class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 mt-1 text-sm">
                                            ...
                                            <option value="editor" {{ old('role', $employee->role) == 'editor' ? 'selected' : '' }}>Content Editor</option>
                                            <option value="sales" {{ old('role', $employee->role) == 'sales' ? 'selected' : '' }}>Sales Staff</option>
                                            <option value="cs" {{ old('role', $employee->role) == 'cs' ? 'selected' : '' }}>Customer Service</option>
                                        </select>
                        ...
                        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6">
                            <div class="flex items-center gap-2 mb-4 border-b border-gray-100 pb-2">
                                ...
                                <h3 class="font-bold text-gray-700 text-lg">Change Password</h3>
                            </div>
                            
                            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-6 text-sm text-yellow-700 flex items-start gap-2">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-admin.text-input type="password" name="password" class="w-full" autocomplete="new-password" />
                                ...
                                <div>
                                    ...
                                    <x-admin.text-input type="password" name="password_confirmation" class="w-full" />
