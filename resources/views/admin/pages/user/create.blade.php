<x-admin.app-layout pageTitle="Add User">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <x-admin.text-input type="email" name="email" :value="old('email')" required class="w-full" />
                                        <x-admin.input-error :messages="$errors->get('email')" />
                                    </div>
                                    <div>
                                        <x-admin.input-label for="phone" value="Phone Number" />
                                        <x-admin.text-input name="phone" :value="old('phone')" class="w-full" />
                        ...
                        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6">
                            ...
                            <div>
                                ...
                                <x-admin.text-input name="company_name" :value="old('company_name')" class="w-full" />
