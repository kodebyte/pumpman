<x-admin.app-layout pageTitle="Edit Subscriber">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="is_active" id="is_active" class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 mt-1 text-sm">
                                <option value="1" {{ old('is_active', $subscriber->is_active) == true ? 'selected' : '' }}>Subscribed</option>
                                <option value="0" {{ old('is_active', $subscriber->is_active) == false ? 'selected' : '' }}>Unsubscribed</option>
                            </select>
