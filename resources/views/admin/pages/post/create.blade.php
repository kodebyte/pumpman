<x-admin.app-layout pageTitle="Write New Post">
    ...
    <div class="pb-12" x-data="postEditor({
        en: { 
            title: '{{ old('title.en') }}', 
            meta_title: '{{ old('meta_title.en') }}', 
            meta_desc: '{{ old('meta_description.en') }}' 
        },
        id: { 
            title: '{{ old('title.id') }}', 
            meta_title: '{{ old('meta_title.id') }}', 
            meta_desc: '{{ old('meta_description.id') }}' 
        }
    })">
                            ...
                            <div class="mt-6 bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
                                ...
                                <div class="font-sans max-w-[600px]">
                                    ...
                                    <h3 class="text-[20px] text-[#1a0dab] font-normal leading-snug hover:underline truncate mb-1" 
                                        x-text="lang === 'en' ? (form.en.meta_title || form.en.title || 'Article Title Placeholder') : (form.id.meta_title || form.id.title || 'Judul Artikel Disini')"></h3>
                                    <div class="text-sm text-[#4d5156] leading-relaxed line-clamp-2">
                                        <span class="text-gray-400 text-xs mr-1">{{ now()->format('M d, Y') }}</span> — 
                                        <span x-text="lang === 'en' ? (form.en.meta_desc || 'Please enter description...') : (form.id.meta_desc || 'Masukkan deskripsi...')"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <x-admin.input-label for="published_at" value="Schedule Publish" />
                                    <input type="datetime-local" name="published_at" value="{{ old('published_at') }}" class="block w-full border-gray-300 rounded-lg shadow-sm mt-1 text-sm">
                                </div>
                            </div>
                            <div class="mt-6 flex flex-col gap-3">
                                <x-admin.primary-button class="justify-center bg-gray-800 hover:bg-gray-700">Save Post</x-admin.primary-button>
                        ...
                        <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                            ...
                            <div>
                                <x-admin.input-label for="thumbnail" value="Thumbnail Image" />
