                        ...
                        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-admin.text-input name="name" :value="old('name')" placeholder="e.g. JNE Express" class="w-full font-semibold" required />
                                    <x-admin.input-error :messages="$errors->get('name')" class="mt-1" />
                                </div>
                                <div>
                                    <x-admin.input-label for="code" value="Service Code (Unique)" />
                                    <x-admin.text-input name="code" :value="old('code')" placeholder="e.g. jne" class="w-full font-mono lowercase bg-gray-50" required />
                            ...
                            <div class="mt-4">
                                ...
                                <x-admin.text-input name="tracking_url_format" :value="old('tracking_url_format')" placeholder="https://cekresi.com/?no={resi}" class="w-full text-sm" />
                                ...
                                <div class="mt-2 relative group cursor-pointer border-2 border-dashed border-gray-300 rounded-xl p-4 hover:bg-gray-50 transition h-48 flex flex-col items-center justify-center overflow-hidden" 
                                    ...
                                    <template x-if="!imgPreview">
                                        <div class="text-center text-gray-400 flex flex-col items-center">
                                            <svg class="mx-auto h-12 w-12 mb-2 text-gray-300" stroke="currentColor" fill="none" viewBox="0 0 48 48">
