<x-admin.app-layout pageTitle="Add Product">
                                ...
                                <div x-show="activeTab === 'general'" x-transition:enter.duration.300ms>
                                    <div class="space-y-6">
                                        <div>
                                            ...
                                            <x-admin.text-input name="name" :value="old('name')" required class="w-full text-lg font-semibold" autofocus />
                                        ...
                                        <div x-data="{ lang: 'en' }" class="bg-gray-50 p-5 rounded-xl border border-gray-100 mt-6">
                                            <div class="flex items-center justify-between mb-6 border-b border-gray-200 pb-4">
                                                ...
                                                <div class="flex bg-white p-1 rounded-lg border border-gray-200 shadow-sm">
                                                    <button type="button" @click="lang = 'en'" :class="lang === 'en' ? 'bg-indigo-50 text-indigo-700 font-bold shadow-sm' : 'text-gray-500 hover:text-gray-700'" class="px-4 py-1.5 text-xs rounded transition-all flex items-center gap-1">
                                                        EN
                                                    </button>
                                                    <button type="button" @click="lang = 'id'" :class="lang === 'id' ? 'bg-indigo-50 text-indigo-700 font-bold shadow-sm' : 'text-gray-500 hover:text-gray-700'" class="px-4 py-1.5 text-xs rounded transition-all flex items-center gap-1">
                                                        ID
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div x-show="lang === 'en'" x-transition:enter.duration.300ms>
                                                <div class="mb-6">
                                                    ...
                                                    <textarea name="short_description[en]" rows="3" class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 text-sm">{{ old('short_description.en') }}</textarea>
                                                    <x-admin.input-error :messages="$errors->get('short_description.en')" class="mt-1" />
                                                </div>

                                                <div wire:ignore>
                                                    <x-admin.input-label value="Full Description" class="mb-1" />
                                                    <textarea id="description_en" name="description[en]" rows="8" class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500">{{ old('description.en') }}</textarea>
                                            ...
                                            <div x-show="lang === 'id'" x-transition:enter.duration.300ms style="display: none;">
                                                <div class="mb-6">
                                                    ...
                                                    <textarea name="short_description[id]" rows="3" class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 text-sm">{{ old('short_description.id') }}</textarea>
                                                    <x-admin.input-error :messages="$errors->get('short_description.id')" class="mt-1" />
                                                </div>

                                                <div wire:ignore>
                                                    <x-admin.input-label value="Deskripsi Lengkap" class="mb-1" />
                                                    <textarea id="description_id" name="description[id]" rows="8" class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500">{{ old('description.id') }}</textarea>
                                ...
                                <div x-show="activeTab === 'pricing'" x-transition:enter.duration.300ms style="display: none;">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <x-admin.text-input type="text" name="sku" :value="old('sku')" class="w-full font-mono uppercase" />
                                        ...
                                        <div x-show="!hasVariants" x-transition>
                                            ...
                                            <x-admin.text-input type="number" name="stock" :value="old('stock', 0)" class="w-full" />
                                        ...
                                        <div class="md:col-span-2 bg-gray-50 p-6 rounded-xl border border-gray-100 mt-4">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                ...
                                                <div x-show="discountType !== ''">
                                                    ...
                                                    <x-admin.text-input type="number" name="discount_value" :value="old('discount_value')" class="w-full mt-1" />
                                                </div>
