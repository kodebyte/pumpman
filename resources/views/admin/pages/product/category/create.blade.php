                        ...
                        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6">
                            ...
                            <div class="space-y-4 min-h-[80px]">
                                <div x-show="lang === 'en'"
                                    ...
                                    <x-admin.text-input name="name[en]" :value="old('name.en')" placeholder="e.g. Audio Systems" class="w-full text-lg font-semibold" required />
                                ...
                                <div x-show="lang === 'id'" 
                                    ...
                                    <x-admin.text-input name="name[id]" :value="old('name.id')" placeholder="cth. Sistem Audio" class="w-full text-lg font-semibold" />
                        ...
                        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6 sticky top-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div x-show="featured == 1" x-transition>
                                    ...
                                    <x-admin.text-input type="number" name="order" :value="old('order', 1)" 
