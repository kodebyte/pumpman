            ...
            <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 flex flex-col">
                ...
                <div class="p-6 border-b border-gray-100">
                    <form method="GET" action="{{ route('admin.categories.index') }}" class="flex flex-col md:flex-row gap-4">
                        ...
                        <button type="submit" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-transparent rounded-lg font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-200 transition">
                            Search
                        </button>

                        @if(request()->hasAny(['search', 'is_featured', 'is_active', 'sort']))
                            <a href="{{ route('admin.categories.index') }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg font-semibold text-xs text-red-500 uppercase tracking-widest hover:bg-red-50 transition">
                                Clear
                            </a>
                        @endif
                    </form>
