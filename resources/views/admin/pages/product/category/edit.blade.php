<x-admin.app-layout pageTitle="Edit Category">

    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    Edit Category: {{ $category->getTranslation('name') }}
                </h2>
                <div class="mt-2">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="lg:col-span-2 space-y-6">
                        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6">
                            ...
                            <div>
                                <x-admin.input-label for="image" value="Thumbnail / Icon" />
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select name="is_active" class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 mt-1 text-sm">
                                        ...
                                        <option value="0" {{ old('is_active', $category->is_active) == false ? 'selected' : '' }}>Draft</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="is_featured" class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 mt-1 text-sm"
                                        ...
                                        <option value="0" {{ old('is_featured', $category->is_featured) == false ? 'selected' : '' }}>No</option>
                                        <option value="1" {{ old('is_featured', $category->is_featured) == true ? 'selected' : '' }}>Yes</option>
                                    </select>
                                ...
                                <div x-show="featured == 1" x-transition>
                                    <x-admin.input-label for="order" value="Order" />
                                    <x-admin.text-input type="number" name="order" :value="old('order', $category->order)" class="w-full text-sm" min="1" />
