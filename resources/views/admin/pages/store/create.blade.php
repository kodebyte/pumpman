                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="bg-blue-50 p-3 rounded-lg flex gap-3 text-xs text-blue-800 border border-blue-100 items-center">
                                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                    <div>
                                        <strong>Tip:</strong> Right-click on Google Maps to copy Lat/Long coordinates.
                                        <a href="https://www.google.com/maps" target="_blank" class="underline font-bold hover:text-blue-600 ml-1">Open Maps →</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6 sticky top-6">
                            ...
                            <div class="mt-6 flex flex-col gap-3">
                                <x-admin.primary-button class="justify-center bg-gray-800 hover:bg-gray-700">{{ __('Save Store') }}</x-admin.primary-button>
