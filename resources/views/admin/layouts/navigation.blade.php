        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-admin.dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-admin.dropdown-link :href="route('admin.users.index')">
                                {{ __('Users') }}
                            </x-admin.dropdown-link>

                            <x-admin.dropdown-link :href="route('admin.employees.index')">
                                {{ __('Employees') }}
                            </x-admin.dropdown-link>

                            <x-admin.dropdown-link :href="route('admin.marketplaces.index')">
                                {{ __('Marketplaces') }}
                            </x-admin.dropdown-link>

                             <x-admin.dropdown-link :href="route('admin.stores.index')">
                                {{ __('Stores') }}
                            </x-admin.dropdown-link>

                            <x-admin.dropdown-link :href="route('admin.careers.index')">
                                {{ __('Careers') }}
                            </x-admin.dropdown-link>
                            ...
                            <x-admin.dropdown-link :href="route('admin.banners.index')">
                                {{ __('Banners') }}
                            </x-admin.dropdown-link>
                            ...
                            <x-admin.dropdown-link :href="route('admin.categories.index')">
                                {{ __('Categories') }}
                            </x-admin.dropdown-link>

                            <x-admin.dropdown-link :href="route('admin.products.index')">
                                {{ __('Products') }}
                            </x-admin.dropdown-link>
                        </x-slot>
                    </x-admin.dropdown>
